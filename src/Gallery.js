...
const Gallery = () => {
  const [setDataGallery] = useState(null);
  ...
  useEffect(() => {
    axios
      .get("http://adminmesuji.embuncode.com/api/image-gallery?instansi_id=21")
      .then(function (Umum) {
  ...
  useEffect(() => {
    axios
      .get("http://adminmesuji.embuncode.com/api/video-gallery?instansi_id=21")
              ...
              return (
                <div className="gallery-item ">
                  ...
                  <div className="gallery-item-caption">
                    ...
                    <p>{item.created_by}</p>
                    {/*</div>*/}
                    {/* <a className="vimeo-popup" href={'https://www.youtube.com/watch?v=' + item.url} /> */}
                  </div>
                </div>
              );
            })}
