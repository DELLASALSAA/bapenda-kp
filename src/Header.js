...
// import NamaInstansi from '../src/assets/bapenda.png';
...
export const Header = (params) => {
  ...
  useEffect(() => {
    axios
      .get("http://adminmesuji.embuncode.com/api/menus?instansi_id=21")
          ...
          <Col>
            <div className="logo-full">
              <div className="logo-header">
                <img className="logo" alt="gambar-4" src={DataHeader.logo_instansi}></img>
              </div>
              <h1 className="text-logo">
                {DataHeader.nama_instansi}
                {/* <img src={NamaInstansi}/> */}
              </h1>
            </div>
          </Col>
