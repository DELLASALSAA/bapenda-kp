...
const Article = () => {
  ...
  const [setActiveArtikelClassname] = useState("d-flex justify-content-between align-items-start kategori-list-article");
  ...
  function getData(page, title) {
    ...
    axios
      .get("http://adminmesuji.embuncode.com/api/article?instansi_id=21" + urlTitle +"&slug=" + ArtikelByKategori + "&per_page=4&page=" + page)
  ...
  useEffect(() => {
    axios
      .get("http://adminmesuji.embuncode.com/api/article/categories/21")
      .then(function (response) {
